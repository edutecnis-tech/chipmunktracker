...
*   **Sintetizador Multi-Canal:** Pistas dedicadas para Melodía, Bajo, Percusión y Efectos (FX).
...
*   **Web Audio API:** Para la síntesis y procesamiento de audio en tiempo real.
*   **JavaScript (Vanilla):** Lógica del secuenciador y manipulación del DOM.
*   **HTML5 & CSS3:** Estructura y diseño responsivo con estética retro.
*   **Vibe Coding Workflow:** Desarrollado utilizando IA (Gemini) para la generación de código, depuración y arquitectura de funciones.
